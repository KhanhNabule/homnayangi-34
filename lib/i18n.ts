...
export const copy = {
  vi: {
    ...
    title: 'Mở hòm ăn trưa', counterPrefix: 'Cư dân mạng đã mở', counterSuffix: 'hòm',
    counterTitle: 'Tổng số lượt quay ước tính của mọi người', caseLabel: 'Mở hòm món ăn',
    ...
    thousandPerMeal: 'nghìn / bữa', spendError: 'Nhập từ 30 đến 180 nghìn.', vegetarianPool: 'Pool chay: trung bình',
  ...
  en: {
    ...
    title: 'Open a lunch case', counterPrefix: 'The internet has opened', counterSuffix: 'cases',
    counterTitle: 'Estimated completed spins worldwide', caseLabel: 'Open a lunch case',
    ...
    thousandPerMeal: 'thousand VND / meal', spendError: 'Enter 30–180 thousand VND.', vegetarianPool: 'Vegetarian pool average',
